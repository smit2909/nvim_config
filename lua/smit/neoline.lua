...
gls.short_line_left[3] = { FileIcon = {
                                        condition = condition.buffer_not_empty,
...
gls.short_line_left[4] = { FileName = {
...
gls.short_line_right[1] = { LineSep = {
                                        highlight = { colors.bg, colors.bg },
...
gls.short_line_right[2] = { LineInfo = {
                                         highlight = { colors.black, colors.bg, 'bold' },
